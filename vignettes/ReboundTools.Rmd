...
The preferences path graph shows details of the substitution and income effects, with 
normalized energy service consumption on the horizontal axis
...
In addition to the `indexed` and `cases` arguments, 
