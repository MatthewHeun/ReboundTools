...
* In particular, the `rebound_analysis()` function performs rebound analysis 
...
* The `rebound_graphs()` function provides `ggplot2` objects that show rebound path graphs.