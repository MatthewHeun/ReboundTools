...
#' @param E_dot_s_orig,E_dot_emb_orig,C_dot_omd_orig,C_dot_g_orig See `ReboundTools::orig_vars`.
#' @param S_dot_dev,E_dot_s_star,E_dot_emb_star,C_dot_omd_star,C_dot_g_star See `ReboundTools::star_vars`.
#' @param E_dot_s_hat,E_dot_emb_hat,C_dot_omd_hat,C_dot_g_hat,N_dot_hat See `ReboundTools::hat_vars`.
#' @param E_dot_s_bar,E_dot_emb_bar,C_dot_omd_bar,C_dot_g_bar See `ReboundTools::bar_vars`.
#' @param E_dot_s_bar,E_dot_emb_bar,C_dot_omd_bar,C_dot_g_bar See `ReboundTools::bar_vars`.
#' @param E_dot_s_tilde,E_dot_emb_tilde,C_dot_omd_tilde,C_dot_g_tilde See `ReboundTools::tilde_vars`.
#'
...
iso_energy_lines <- function(.rebound_data, 
  ...
  y <- .rebound_data[[E_dot_emb_star]] + 
    (.rebound_data[[C_dot_omd_star]] + .rebound_data[[C_dot_g_star]]) * .rebound_data[[I_E]]
  isos <- isos %>% 
    add_iso(indexed = indexed, 
            meta = meta, 
            graph_type = graph_type, 
  ...
  y <- .rebound_data[[E_dot_emb_hat]] + 
    (.rebound_data[[C_dot_omd_hat]] + .rebound_data[[C_dot_g_hat]]) * .rebound_data[[I_E]]
  isos <- isos %>% 
    add_iso(indexed = indexed, 
            meta = meta, 
            graph_type = graph_type, 
  ...
  y <- .rebound_data[[E_dot_emb_bar]] + 
    (.rebound_data[[C_dot_omd_bar]] + .rebound_data[[C_dot_g_bar]]) * .rebound_data[[I_E]]
  isos <- isos %>% 
    add_iso(indexed = indexed, 
            meta = meta, 
            graph_type = graph_type, 
  ...
  y <- .rebound_data[[E_dot_emb_tilde]] + 
    (.rebound_data[[C_dot_omd_tilde]] + .rebound_data[[C_dot_g_tilde]]) * .rebound_data[[I_E]] + 
...
iso_budget_lines_cons <- function(.rebound_data, 
  ...
  # Iso-budget line at the orig point (o--o, before emplacement) 
  ...
  intercept_hat <- (.rebound_data[[M_dot_orig]] - 
                      ...
                      .rebound_data[[Delta_C_dot_g_hat]]) / 
    .rebound_data[[C_dot_g_orig]]
  out <- add_budget_line(out, meta = meta, 
                         graph_type = graph_type,
  ...
  # slope_ray <- (C_dot_g_hat / C_dot_g_orig) / (q_dot_s_hat / q_dot_s_orig)
  slope_ray <- (.rebound_data[[C_dot_g_hat]] / .rebound_data[[C_dot_g_orig]]) /
