...
iso_energy_lines <- function(.rebound_data, 
  ...
  isos <- add_iso(indexed = indexed, 
                  ...
                  linewidth = graph_params$hundred_perc_rebound_grid_size, 
  ...
  isos <- isos %>% 
    add_iso(indexed = indexed, 
            ...
            linewidth = graph_params$zero_perc_rebound_grid_size, 
  ...
  isos <- isos %>% 
    add_iso(indexed = indexed, 
            ...
            linewidth = graph_params$energy_grid_size, 
...
iso_expenditure_lines <- function(.rebound_data, 
  ...
  isos <- add_iso(indexed = indexed,
                  ...
                  linewidth = graph_params$expenditure_grid_size, 
...
iso_budget_lines_cons <- function(.rebound_data, 
  ...
  out <- add_budget_line(meta = meta, 
                         ...
                         size = graph_params$cons_grid_size, 
  ...
  out <- add_budget_line(out, meta = meta, 
          ...
          size = graph_params$cons_ray_size, 
...
add_budget_line <- function(.DF = NULL, 
                            ...
                            size = ReboundTools::path_graph_params$cons_grid_size, 
...
add_iso <- function(.DF = NULL, 
                    ...
                    linewidth = ReboundTools::path_graph_params$energy_grid_size, 
