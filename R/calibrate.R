...
#' `S_dot_dev / (N_dot_star * I_E) * [Re_macro + (Re_tot_target - Re_tot)]`.
#' 
...
#' @param N_dot_star_colname See `ReboundTools::star_vars`.
...
calibrate_k <- function(.rebound_data, Re_tot_target, 
  ...
  .rebound_data[[S_dot_dev_colname]] / .rebound_data[[N_dot_star_colname]] / .rebound_data[[I_E_colname]] * 
