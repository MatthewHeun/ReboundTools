...
energy_paths <- function(.rebound_data, 
  ...
  paths <- add_segment(indexed = indexed,
                       ...
                       linewidth = graph_params$dempl_size,
  ...
  paths <- paths %>% 
    add_segment(indexed = indexed,
                ...
                linewidth = graph_params$emb_size,
  ...
  paths <- paths %>% 
    add_segment(indexed = indexed,
                ...
                linewidth = graph_params$md_size,
  ...
  paths <- paths %>%
    add_segment(indexed = indexed,
                ...
                linewidth = graph_params$isub_size,
  ...
  paths <- paths %>% 
    add_segment(indexed = indexed,
                ...
                linewidth = graph_params$dsub_size,
  ...
  paths <- paths %>% 
    add_segment(indexed = indexed,
                ...
                linewidth = graph_params$dinc_size,
  ...
  paths <- paths %>% 
    add_segment(indexed = indexed,
                ...
                linewidth = graph_params$iinc_size,
  ...
  paths <- paths %>% 
    add_segment(indexed = indexed,
                ...
                linewidth = graph_params$macro_size,
...
expenditure_paths <- function(.rebound_data, 
  ...
  paths <- paths %>% 
    add_segment(indexed = indexed,
                ...
                linewidth = graph_params$cap_size,
...
add_segment <- function(.DF = NULL, 
  ...
  out <- meta %>% 
    dplyr::mutate(
      ...
      "{graph_df_colnames$size_col}" := linewidth,
