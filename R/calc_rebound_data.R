...
#' @param r,MJ_engr_unit,p_E_engr_units,e_qs_ps_UC_orig,e_qs_M,e_qg_M See `ReboundTools::eeu_base_params`.
#' @param tau_alpha_orig,tau_omega_orig,eta_engr_units_orig,q_dot_s_orig,M_dot_orig,C_cap_orig,tau_alpha_C_dot_cap_orig,C_d_orig,C_dot_omd_orig,C_dot_om_orig,C_dot_d_orig,tau_omega_C_dot_d_orig,E_emb_orig,t_life_orig,p_E,eta_orig,E_dot_s_orig,C_dot_cap_orig,p_s_orig,C_dot_s_orig,C_dot_g_orig,f_Cs_orig,e_qg_ps_UC_orig,e_qs_ps_C_orig,e_qg_ps_C_orig,sigma,rho,E_dot_emb_orig,N_dot_orig,p_E_orig See `ReboundTools::orig_vars`.
#' 
...
calc_orig <- function(.eeu_data = NULL,
  ...
  calc_orig_fun <- function(r_val, 
    ...
    if (r_val == 0) {
      ...
      tau_alpha_orig_val <- 1
      tau_omega_orig_val <- 1
    } else {
      ...
      tau_alpha_orig_val <- (phi_t_life_orig_val / phi_1_year_orig_val) * t_life_orig_val # / 1 year
      tau_omega_orig_val <- (gamma_t_life_orig_val / phi_1_year_orig_val) * t_life_orig_val # / 1 year
    }
      
    p_E_val <- p_E_engr_units_val / MJ_engr_unit_val
    p_E_orig_val <- p_E_val
    ...
    tau_alpha_C_dot_cap_orig_val <- tau_alpha_orig_val * C_dot_cap_orig_val
    ...
    tau_omega_C_dot_d_orig_val <- tau_omega_orig_val * C_dot_d_orig_val
    C_dot_omd_orig_val <- C_dot_om_orig_val + tau_omega_orig_val * C_dot_d_orig_val
    C_dot_g_orig_val <- M_dot_orig_val - C_dot_s_orig_val - tau_alpha_orig_val * C_dot_cap_orig_val - C_dot_omd_orig_val
    ...
    e_qg_ps_UC_orig_val <- f_Cs_orig_val * (sigma_val - e_qg_M_val)
    e_qs_ps_C_orig_val <- e_qs_ps_UC_orig_val + f_Cs_orig_val*e_qs_M_val
    e_qg_ps_C_orig_val <- f_Cs_orig_val*(f_Cs_orig_val + e_qs_ps_UC_orig_val) / (f_Cs_orig_val - 1)
    E_dot_emb_orig_val <- E_emb_orig_val / t_life_orig_val
    N_dot_orig_val <- M_dot_orig_val - (tau_alpha_orig_val*C_dot_cap_orig_val + 
                                        C_dot_s_orig_val + 
                                        C_dot_omd_orig_val +
                                        C_dot_g_orig_val)
    ...
    list(tau_alpha_orig_val, 
         ...
         E_dot_s_orig_val,
         C_dot_cap_orig_val,
         tau_alpha_C_dot_cap_orig_val,
         p_s_orig_val,
         C_dot_s_orig_val,
         C_dot_d_orig_val,
         tau_omega_C_dot_d_orig_val,
         C_dot_omd_orig_val,
         C_dot_g_orig_val,
         f_Cs_orig_val,
         e_qg_ps_UC_orig_val,
         ...
         E_dot_emb_orig_val,
         N_dot_orig_val) %>% 
      magrittr::set_names(c(tau_alpha_orig, 
                            tau_omega_orig, 
                            p_E, 
                            p_E_orig,
                            eta_orig,
...
#' @param tau_alpha_orig,C_dot_omd_orig,C_dot_om_star,C_d_star,C_dot_d_star,tau_omega_C_dot_d_star,C_dot_omd_star,eta_orig,E_dot_s_orig,q_dot_s_orig,M_dot_orig,C_dot_cap_orig,C_dot_g_orig,e_qs_ps_UC_orig,e_qg_ps_UC_orig,e_qs_ps_C_orig,e_qg_ps_C_orig See `ReboundTools::orig_vars`.
#' @param tau_alpha_star,tau_omega_star,eta_engr_units_star,E_emb_star,t_life_star,C_cap_star,eta_star,eta_ratio,S_dot_dev,G_dot,p_s_star,q_dot_s_star,C_dot_cap_star,tau_alpha_C_dot_cap_star,E_dot_emb_star,C_dot_s_star,M_dot_star,N_dot_star,C_dot_g_star,f_Cs_star,e_qs_ps_UC_star,e_qg_ps_UC_star,e_qs_ps_C_star,e_qg_ps_C_star,E_dot_s_star,p_E_star See `ReboundTools::star_vars`.
#' 
...
calc_star <- function(.orig_data = NULL,
                      ...
                      p_E_star = ReboundTools::star_vars$p_E_star,
                      ...
                      tau_alpha_C_dot_cap_star = ReboundTools::star_vars$tau_alpha_C_dot_cap_star,
                      ...
                      tau_omega_C_dot_d_star = ReboundTools::star_vars$tau_omega_C_dot_d_star,
                      ...
                      e_qg_ps_UC_star = ReboundTools::star_vars$e_qg_ps_UC_star,
                      e_qs_ps_C_star = ReboundTools::star_vars$e_qs_ps_C_star,
                      e_qg_ps_C_star = ReboundTools::star_vars$e_qg_ps_C_star,
  ...
  calc_star_fun <- function(r_val, 
    ...
    if (r_val == 0) {
      # Address the degenerate case.
      tau_alpha_star_val <- 1
      tau_omega_star_val <- 1
    } else {
      ...
      tau_alpha_star_val <- (phi_t_life_star_val / phi_1_year_star_val) * t_life_star_val # / 1 year
      tau_omega_star_val <- (gamma_t_life_star_val / phi_1_year_star_val) * t_life_star_val # / 1 year
    }
    
    p_E_star_val <- p_E_val
    ...
    C_dot_cap_star_val <- C_cap_star_val / t_life_star_val
    tau_alpha_C_dot_cap_star_val <- tau_alpha_star_val * C_dot_cap_star_val
    E_dot_emb_star_val <- E_emb_star_val / t_life_star_val
    C_dot_s_star_val <- p_s_star_val * q_dot_s_star_val
    C_dot_d_star_val <- C_d_star_val / t_life_star_val
    tau_omega_C_dot_d_star_val <- tau_omega_star_val * C_dot_d_star_val
    C_dot_omd_star_val <- C_dot_om_star_val + tau_omega_star_val * C_dot_d_star_val
    
    M_dot_star_val <- M_dot_orig_val
    N_dot_star_val <- G_dot_val - 
                      (tau_alpha_star_val*C_dot_cap_star_val - tau_alpha_orig_val*C_dot_cap_orig_val) - 
    ...
    e_qg_ps_UC_star_val <- e_qg_ps_UC_orig_val 
    e_qs_ps_C_star_val <- e_qs_ps_C_orig_val
    e_qg_ps_C_star_val <- e_qg_ps_C_orig_val

    list(tau_alpha_star_val, 
         tau_omega_star_val, 
         eta_star_val,
         eta_ratio_val,
         S_dot_dev_val,
         ...
         q_dot_s_star_val,
         C_dot_cap_star_val,
         tau_alpha_C_dot_cap_star_val,
         E_dot_emb_star_val,
         C_dot_s_star_val,
         C_dot_d_star_val,
         tau_omega_C_dot_d_star_val,
         C_dot_omd_star_val,
         M_dot_star_val,
         N_dot_star_val,
         C_dot_g_star_val,
         ...
         e_qs_ps_C_star_val,
         e_qg_ps_C_star_val) %>% 
      magrittr::set_names(c(tau_alpha_star, 
                            tau_omega_star, 
                            eta_star,
                            eta_ratio,
                            S_dot_dev,
                            ...
                            q_dot_s_star,
                            C_dot_cap_star,
                            tau_alpha_C_dot_cap_star,
                            E_dot_emb_star,
                            C_dot_s_star,
                            C_dot_d_star,
                            tau_omega_C_dot_d_star,
                            C_dot_omd_star,
                            M_dot_star,
                            N_dot_star,
                            C_dot_g_star, 
  ...
  matsindf::matsindf_apply(.orig_data, FUN = calc_star_fun, 
                           ...
                           tau_alpha_orig_val = tau_alpha_orig,
                           MJ_engr_unit_val = MJ_engr_unit,
...
#' @param e_qs_M,e_qg_M See `ReboundTools::eeu_base_params`.
#' @param e_qo_ps_C,e_qs_ps_C,C_dot_cap_orig,f_Cs_orig,q_dot_s_orig,C_dot_g_orig,sigma,rho See `ReboundTools::orig_vars`.
#' @param t_life_star,C_dot_om_star,C_d_star,C_dot_d_star,C_dot_omd_star,tau_alpha_star,tau_omega_star,eta_engr_units_star,eta_star,p_s_star,C_dot_cap_star,E_dot_emb_star,M_dot_star,q_dot_s_star,eta_ratio,C_dot_g_star,e_qs_ps_UC_star,e_qg_ps_UC_star,e_qs_ps_C_star,e_qg_ps_C_star,N_dot_star,E_dot_s_star,G_dot See `ReboundTools::star_vars`.
#' @param t_life_hat,C_d_hat,C_dot_d_hat,tau_omega_C_dot_d_hat,C_dot_om_hat,C_dot_omd_hat,tau_alpha_hat,tau_omega_hat,eta_engr_units_hat,eta_hat,p_s_hat,C_dot_cap_hat,tau_alpha_C_dot_cap_hat,E_dot_emb_hat,M_dot_hat,q_dot_s_hat,E_dot_s_hat,C_dot_s_hat,C_dot_g_hat,f_Cs_hat,e_qs_ps_UC_hat,e_qg_ps_UC_hat,e_qs_ps_C_hat,e_qg_ps_C_hat,N_dot_hat,M_dot_hat_prime,p_E_hat See `ReboundTools::hat_vars`.
#'      
...
calc_hat <- function(.star_data = NULL,
                     ...
                     tau_omega_hat = ReboundTools::hat_vars$tau_omega_hat,
                     ...
                     tau_alpha_C_dot_cap_hat = ReboundTools::hat_vars$tau_alpha_C_dot_cap_hat,
                     ...
                     tau_omega_C_dot_d_hat = ReboundTools::hat_vars$tau_omega_C_dot_d_hat,
  ...
  calc_hat_fun <- function(t_life_star_val,
    ...
    p_E_hat_val <- p_E_val
    t_life_hat_val <- t_life_star_val
    tau_alpha_hat_val <- tau_alpha_star_val
    tau_omega_hat_val <- tau_omega_star_val
    ...
    tau_alpha_C_dot_cap_hat_val <- tau_alpha_hat_val * C_dot_cap_hat_val
    C_dot_om_hat_val <- C_dot_om_star_val
    C_d_hat_val <- C_d_star_val
    C_dot_d_hat_val <- C_dot_d_star_val
    tau_omega_C_dot_d_hat_val <- tau_omega_hat_val * C_dot_d_hat_val
    C_dot_omd_hat_val <- C_dot_omd_star_val
    ...
    e_qg_ps_C_hat_val <- (m_o * n * f * zpsmo) / (1 + f*(zpsmo - 1))
    e_qs_ps_UC_hat_val <- e_qs_ps_C_hat_val - f_Cs_hat_val * e_qs_M_val
    e_qg_ps_UC_hat_val <- f_Cs_hat_val * (sigma_val - e_qg_M_val)
    
    N_dot_hat_val <- N_dot_star_val - p_E_val*(E_dot_s_hat_val - E_dot_s_star_val) - (C_dot_g_hat_val - C_dot_g_star_val)
    M_dot_hat_prime_val <- M_dot_hat_val - tau_alpha_star_val * C_dot_cap_star_val -
                           C_dot_omd_star_val - N_dot_hat_val
    
    list(t_life_hat_val, 
         tau_alpha_hat_val, 
         tau_omega_hat_val, 
         eta_engr_units_hat_val,
         eta_hat_val,
         p_E_hat_val,
         p_s_hat_val,
         C_dot_cap_hat_val,
         tau_alpha_C_dot_cap_hat_val,
         E_dot_emb_hat_val,
         M_dot_hat_val,
         q_dot_s_hat_val,
         E_dot_s_hat_val,
         ...
         N_dot_hat_val,
         M_dot_hat_prime_val) %>%
      magrittr::set_names(c(t_life_hat, 
                            tau_alpha_hat, 
                            tau_omega_hat, 
                            eta_engr_units_hat,
                            eta_hat,
  ...
  matsindf::matsindf_apply(.star_data, FUN = calc_hat_fun, 
                           t_life_star_val = t_life_star,
                           tau_alpha_star_val = tau_alpha_star,
                           tau_omega_star_val = tau_omega_star,
                           e_qs_M_val = e_qs_M, 
                           e_qg_M_val = e_qg_M,
                           eta_engr_units_star_val = eta_engr_units_star,
                           ...
                           C_dot_omd_star_val = C_dot_omd_star,
                           ...
                           e_qg_ps_C_star_val = e_qg_ps_C_star,
                           e_qs_ps_UC_star_val = e_qs_ps_UC_star,
                           e_qg_ps_UC_star_val = e_qg_ps_UC_star,
...
#' @param e_qs_M,e_qg_M,p_E See `ReboundTools::eeu_base_params`.
#' @param t_life_hat,C_d_hat,C_dot_d_hat,C_dot_om_hat,C_dot_omd_hat,tau_alpha_hat,tau_omega_hat,eta_engr_units_hat,eta_hat,p_s_hat,C_dot_cap_hat,E_dot_emb_hat,M_dot_hat,q_dot_s_hat,N_dot_hat,M_dot_hat_prime,C_dot_g_hat,e_qs_ps_UC_hat,e_qg_ps_UC_hat,e_qs_ps_C_hat,e_qg_ps_C_hat,E_dot_s_hat See `ReboundTools::hat_vars`.
#' @param t_life_bar,C_d_bar,C_dot_d_bar,tau_omega_C_dot_d_bar,C_dot_om_bar,C_dot_omd_bar,tau_alpha_bar,tau_omega_bar,eta_engr_units_bar,eta_bar,p_s_bar,C_dot_cap_bar,tau_alpha_C_dot_cap_bar,E_dot_emb_bar,M_dot_bar,q_dot_s_bar,E_dot_s_bar,C_dot_s_bar,C_dot_g_bar,f_Cs_bar,e_qs_ps_UC_bar,e_qg_ps_UC_bar,e_qs_ps_C_bar,e_qg_ps_C_bar,N_dot_bar,p_E_bar See `ReboundTools::bar_vars`.
#' 
...
calc_bar <- function(.hat_data = NULL,
                     ...
                     tau_alpha_bar = ReboundTools::bar_vars$tau_alpha_bar, 
                     tau_omega_bar = ReboundTools::bar_vars$tau_omega_bar,
                     ...
                     tau_alpha_C_dot_cap_bar = ReboundTools::bar_vars$tau_alpha_C_dot_cap_bar,
                     ...
                     tau_omega_C_dot_d_bar = ReboundTools::bar_vars$tau_omega_C_dot_d_bar,
                     ...
                     e_qg_ps_UC_bar = ReboundTools::bar_vars$e_qg_ps_UC_bar,
                     e_qs_ps_C_bar = ReboundTools::bar_vars$e_qs_ps_C_bar,
                     e_qg_ps_C_bar = ReboundTools::bar_vars$e_qg_ps_C_bar,
                     N_dot_bar = ReboundTools::bar_vars$N_dot_bar
) {
  
  calc_bar_fun <- function(t_life_hat_val, 
                           tau_alpha_hat_val, 
                           tau_omega_hat_val,
                           eta_engr_units_hat_val,
                           eta_hat_val, 
    ...
    p_E_bar_val <- p_E_val
    t_life_bar_val <- t_life_hat_val
    tau_alpha_bar_val <- tau_alpha_hat_val
    tau_omega_bar_val <- tau_omega_hat_val
    ...
    tau_alpha_C_dot_cap_bar_val <- tau_alpha_bar_val * C_dot_cap_bar_val
    ...
    C_dot_om_bar_val <- C_dot_om_hat_val
    C_d_bar_val <- C_d_hat_val
    C_dot_d_bar_val <- C_dot_d_hat_val
    tau_omega_C_dot_d_bar_val <- tau_omega_bar_val * C_dot_d_bar_val
    C_dot_omd_bar_val <- C_dot_omd_hat_val
    C_dot_g_bar_val <- C_dot_g_hat_val * (1 + N_dot_hat_val/M_dot_hat_prime_val)^(e_qg_M_val)
    ...
    e_qg_ps_UC_bar_val <- e_qg_ps_UC_hat_val
    e_qs_ps_C_bar_val <- e_qs_ps_C_hat_val
    e_qg_ps_C_bar_val <- e_qg_ps_C_hat_val
    
    list(t_life_bar_val, 
         tau_alpha_bar_val, 
         tau_omega_bar_val, 
         eta_engr_units_bar_val,
         eta_bar_val,
         p_E_bar_val,
         p_s_bar_val,
         C_dot_cap_bar_val,
         tau_alpha_C_dot_cap_bar_val,
         E_dot_emb_bar_val,
         M_dot_bar_val, 
         q_dot_s_bar_val,
         E_dot_s_bar_val,
         ...
         e_qg_ps_C_bar_val,
         N_dot_bar_val) %>% 
      magrittr::set_names(c(t_life_bar, 
                            tau_alpha_bar,
                            tau_omega_bar,
                            eta_engr_units_bar,
                            eta_bar,
  ...
  matsindf::matsindf_apply(.hat_data, FUN = calc_bar_fun,
                           t_life_hat_val = t_life_hat,
                           tau_alpha_hat_val = tau_alpha_hat, 
                           tau_omega_hat_val = tau_omega_hat,
                           ...
                           e_qg_ps_UC_hat_val = e_qg_ps_UC_hat,
                           e_qs_ps_C_hat_val = e_qs_ps_C_hat,
                           e_qg_ps_C_hat_val = e_qg_ps_C_hat)
}
...
#' @param t_life_bar,C_dot_om_bar,C_d_bar,C_dot_d_bar,C_dot_omd_bar,tau_alpha_bar,tau_omega_bar,eta_engr_units_bar,eta_bar,p_s_bar,C_dot_cap_bar,E_dot_emb_bar,M_dot_bar,q_dot_s_bar,E_dot_s_bar,C_dot_s_bar,C_dot_g_bar,e_qs_ps_UC_bar,e_qg_ps_UC_bar,e_qs_ps_C_bar,e_qg_ps_C_bar,N_dot_bar See `ReboundTools::bar_vars`.
#' @param t_life_tilde,C_dot_om_tilde,C_d_tilde,C_dot_d_tilde,tau_omega_C_dot_d_tilde,C_dot_omd_tilde,tau_alpha_tilde,tau_omega_tilde,eta_engr_units_tilde,eta_tilde,p_s_tilde,C_dot_cap_tilde,tau_alpha_C_dot_cap_tilde,E_dot_emb_tilde,M_dot_tilde,q_dot_s_tilde,E_dot_s_tilde,C_dot_s_tilde,C_dot_g_tilde,f_Cs_tilde,e_qs_ps_UC_tilde,e_qg_ps_UC_tilde,e_qs_ps_C_tilde,e_qg_ps_C_tilde,N_dot_tilde,p_E_tilde See `ReboundTools::tilde_vars`.
#'
#' @return A list or data frame of derived rebound values for the bar stage (after the income effect).
#' 
#' @export
...
calc_tilde <- function(.bar_data = NULL,
                       ...
                       # Output names
                       t_life_tilde = ReboundTools::tilde_vars$t_life_tilde,
                       tau_alpha_tilde = ReboundTools::tilde_vars$tau_alpha_tilde, 
                       tau_omega_tilde = ReboundTools::tilde_vars$tau_omega_tilde,
                       eta_engr_units_tilde = ReboundTools::tilde_vars$eta_engr_units_tilde,
                       eta_tilde = ReboundTools::tilde_vars$eta_tilde,
                       p_E_tilde = ReboundTools::tilde_vars$p_E_tilde,
                       p_s_tilde = ReboundTools::tilde_vars$p_s_tilde,
                       C_dot_cap_tilde = ReboundTools::tilde_vars$C_dot_cap_tilde,
                       tau_alpha_C_dot_cap_tilde = ReboundTools::tilde_vars$tau_alpha_C_dot_cap_tilde,
                       ...
                       C_dot_om_tilde = ReboundTools::tilde_vars$C_dot_om_tilde,
                       C_d_tilde = ReboundTools::tilde_vars$C_d_tilde,
                       C_dot_d_tilde = ReboundTools::tilde_vars$C_dot_d_tilde,
                       tau_omega_C_dot_d_tilde = ReboundTools::tilde_vars$tau_omega_C_dot_d_tilde,                       
                       ...
                       e_qg_ps_UC_tilde = ReboundTools::tilde_vars$e_qg_ps_UC_tilde,
                       e_qs_ps_C_tilde = ReboundTools::tilde_vars$e_qs_ps_C_tilde,
                       e_qg_ps_C_tilde = ReboundTools::tilde_vars$e_qg_ps_C_tilde,
                       N_dot_tilde = ReboundTools::tilde_vars$N_dot_tilde
) {
  
  calc_tilde_fun <- function(t_life_bar_val, 
                             tau_alpha_bar_val, 
                             tau_omega_bar_val,
                             eta_engr_units_bar_val,
                             eta_bar_val, 
    ...
    p_E_tilde_val <- p_E_val
    t_life_tilde_val <- t_life_bar_val
    tau_alpha_tilde_val <- tau_alpha_bar_val
    tau_omega_tilde_val <- tau_omega_bar_val
    ...
    tau_alpha_C_dot_cap_tilde_val <- tau_alpha_tilde_val * C_dot_cap_tilde_val
    ...
    C_dot_om_tilde_val <- C_dot_om_bar_val
    C_d_tilde_val <- C_d_bar_val
    C_dot_d_tilde_val <- C_dot_d_bar_val
    tau_omega_C_dot_d_tilde_val <- tau_omega_tilde_val * C_dot_d_tilde_val
    ...
    e_qg_ps_UC_tilde_val <- e_qg_ps_UC_bar_val
    e_qs_ps_C_tilde_val <- e_qs_ps_C_bar_val
    e_qg_ps_C_tilde_val <- e_qg_ps_C_bar_val
    
    N_dot_tilde_val <- N_dot_bar_val
    
    list(t_life_tilde_val, 
         tau_alpha_tilde_val, 
         tau_omega_tilde_val, 
         eta_engr_units_tilde_val,
         eta_tilde_val,
         p_E_tilde_val,
         p_s_tilde_val,
         C_dot_cap_tilde_val,
         tau_alpha_C_dot_cap_tilde_val,
         E_dot_emb_tilde_val,
         M_dot_tilde_val, 
         q_dot_s_tilde_val,
         E_dot_s_tilde_val,
         ...
         C_d_tilde_val,
         C_dot_d_tilde_val,
         tau_omega_C_dot_d_tilde_val,
         C_dot_omd_tilde_val,
         C_dot_g_tilde_val,
         f_Cs_tilde_val,
         e_qs_ps_UC_tilde_val,
         e_qg_ps_UC_tilde_val,
         e_qs_ps_C_tilde_val,
         e_qg_ps_C_tilde_val,
         N_dot_tilde_val) %>% 
      magrittr::set_names(c(t_life_tilde, 
                            tau_alpha_tilde, 
                            tau_omega_tilde,
  ...
  matsindf::matsindf_apply(.bar_data, FUN = calc_tilde_fun,
                           t_life_bar_val = t_life_bar,
                           tau_alpha_bar_val = tau_alpha_bar, 
                           tau_omega_bar_val = tau_omega_bar,
...
#' @param I_E,e_qs_M,e_qg_M,k See `ReboundTools::eeu_base_params`.
...
#' @param tau_alpha_orig,C_dot_cap_orig,tau_omega_orig,C_dot_d_orig See `ReboundTools::orig_vars`.
#' @param tau_alpha_star,tau_omega_star,C_dot_d_star,C_dot_cap_star,Delta_C_dot_om_star,Delta_C_dot_omd_star,Delta_E_dot_emb_star,Delta_E_dot_s_hat,Delta_C_dot_g_hat,Delta_E_dot_s_bar,Delta_C_dot_g_bar See `ReboundTools::Delta_vars`.
...
calc_rebound <- function(.Deltas_data = NULL, 
  ...
  rebound_fun <- function(Delta_E_dot_emb_star_val, 
    ...
    Re_cap_val <- (tau_alpha_star_val*C_dot_cap_star_val - tau_alpha_orig_val*C_dot_cap_orig_val) * I_E_val / S_dot_dev_val

    Re_om_val <- Delta_C_dot_om_star_val * I_E_val / S_dot_dev_val
    
    Re_d_val <- (tau_omega_star_val*C_dot_d_star_val - tau_omega_orig_val*C_dot_d_orig_val) * I_E_val / S_dot_dev_val
  ...
  matsindf::matsindf_apply(.Deltas_data, FUN = rebound_fun, 
                           ...
                           C_dot_cap_orig_val = C_dot_cap_orig, 
                           C_dot_cap_star_val = C_dot_cap_star,
                           tau_omega_orig_val = tau_omega_orig, 
                           tau_omega_star_val = tau_omega_star,
