...
test_that("calc_star() works as expected", {
  ...
  expect_equal(res[[ReboundTools::star_vars$e_qo_ps_UC_star]][[1]], 0.0000000000)
  expect_equal(res[[ReboundTools::star_vars$e_qo_ps_UC_star]][[2]], 0.0000000000)
...
test_that("calc_hat(use_sub_approx = TRUE) works as expected", {
  ...
  expect_equal(res[[ReboundTools::hat_vars$e_qo_ps_UC_hat]][[1]], 0.0000000000)
  expect_equal(res[[ReboundTools::hat_vars$e_qo_ps_UC_hat]][[2]], 0.0000000000)
...
test_that("calc_bar() works as expected with approximated hat", {
  ...
  expect_equal(res[[ReboundTools::bar_vars$e_qo_ps_UC_bar]][[1]], 0.0000000000)
  expect_equal(res[[ReboundTools::bar_vars$e_qo_ps_UC_bar]][[2]], 0.0000000000)
