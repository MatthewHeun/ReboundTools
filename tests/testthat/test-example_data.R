...
test_that("load_eeu_data() works as expected", {
  ...
  required_cols <- c(ReboundTools::eeu_base_params, 
                     orig_vars[c("eta_engr_units_orig", "q_dot_s_orig", "M_dot_orig", "C_cap_orig", "t_own_orig", "C_dot_md_orig", "E_emb_orig", "t_life_orig")], 
                     star_vars[c("eta_engr_units_star", "C_cap_star", "t_own_star", "C_dot_md_star", "E_emb_star", "t_life_star")])
